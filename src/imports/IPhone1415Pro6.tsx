import svgPaths from "./svg-0n8bbyflna";
...
function Frame6() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] items-start left-[24px] top-[246px] w-[345px]">
...
function Frame2() {
  return (
    <div className="bg-white relative rounded-[8px] shrink-0 size-[44px]">
      <div aria-hidden="true" className="absolute border border-[#c6c6c6] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] items-start left-[24px] top-[336px] w-[345px]">
      <p className="font-['Instrument_Sans:Regular',sans-serif] font-normal leading-[normal] min-w-full relative shrink-0 text-[#333] text-[14px] w-[min-content] whitespace-pre-wrap" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Frame() {
  return (
    <div className="absolute bg-[#008080] content-stretch flex items-center justify-center left-[24px] p-[16px] rounded-[8px] top-[537px] w-[345px]">
...
function Frame10() {
  return (
    <div className="content-stretch flex items-center justify-center px-[10px] py-[8px] relative shrink-0 w-[108px]">
      <p className="font-['Instrument_Sans:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#1e1e1e] text-[24px] text-center tracking-[-1.2px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Register
      </p>
    </div>
  );
...
function Frame9() {
  return (
    <div className="content-stretch flex items-center justify-center px-[10px] py-[8px] relative shrink-0 w-[108px]">
      <div aria-hidden="true" className="absolute border-[#008080] border-b-4 border-solid inset-[0_0_-4px_0] pointer-events-none" />
      <p className="font-['Instrument_Sans:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#008080] text-[24px] text-center tracking-[-1.2px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Log In
      </p>
    </div>
  );
...
function Frame11() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex items-center left-[calc(50%+0.5px)] top-[140px]">
      <Frame10 />
      <Frame9 />
    </div>
  );
...
export default function IPhone1415Pro() {
  return (
    <div className="bg-[#f8fafc] relative size-full" data-name="iPhone 14 & 15 Pro - 6">
      <Frame6 />
      <Frame7 />
      <HomeBarPro />
      <StatusBarPro />
