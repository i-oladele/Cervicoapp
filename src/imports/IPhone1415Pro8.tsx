import svgPaths from "./svg-fkubsbsswt";
...
function Frame4() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] items-start left-[24px] top-[266px] w-[345px]">
      <p className="font-['Instrument_Sans:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#333] text-[14px] w-full whitespace-pre-wrap" style={{ fontVariationSettings: "'wdth' 100" }}>{`Select Screening Center `}</p>
      <Frame1 />
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] items-start left-[24px] top-[173px] w-[345px]">
...
function CalendarDots() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="CalendarDots">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="CalendarDots">
          <path d={svgPaths.p1e710300} fill="var(--fill-0, #C6C6C6)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame9() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] items-start left-[24px] top-[359px] w-[345px]">
      <p className="font-['Instrument_Sans:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#333] text-[14px] w-full whitespace-pre-wrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        Date of Screening
      </p>
      <Frame3 />
...
function ToggleRight() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="ToggleRight">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="ToggleRight">
          <path d={svgPaths.p362ad900} fill="var(--fill-0, #008080)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame10() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[24px] top-[452px] w-[345px]">
      <p className="font-['Instrument_Sans:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#333] text-[16px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Set daily reminder
      </p>
      <ToggleRight />
    </div>
...
function Hospital() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Hospital">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Hospital">
          <path d={svgPaths.p1c590b70} fill="var(--fill-0, #008080)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame() {
  return (
    <div className="absolute bg-[#008080] content-stretch flex items-center justify-center left-[24px] p-[16px] rounded-[8px] top-[572px] w-[345px]">
      <p className="font-['Instrument_Sans:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#8ffc86] text-[18px] text-center tracking-[-0.9px] w-[163px] whitespace-pre-wrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        Save Screening Date
      </p>
    </div>
  );
...
export default function IPhone1415Pro() {
  return (
    <div className="bg-[#f8fafc] relative size-full" data-name="iPhone 14 & 15 Pro - 8">
      <HomeBarPro />
      <StatusBarPro />
      <Frame4 />
      <Frame11 />
